            ...
            <div className="col-lg-8 col-md-10 mx-auto">
                ...
                <div>
                    ...
                    <div>
                        ...
                        {props.version === "long" && <p style={contentStyle}>Greetings! My name is Drew Fleming and I am an avid web developer working for <a href="https://www.trackabout.com">TrackAbout</a> (Check us out for all you're asset tracking needs)! I earned my degree in computer science in 2007 and immediately after I started my career as a software tester. As long as I can remember I wanted to write code for a living, and I was given the opportunity to do so in 2009. Since then, I have been a full stack developer helping companies of all sizes. Over the years I have gained expert level skills in .NET and a deep passion for developing for the web.</p>}
